...
?>
<div class="main-filters-base">
  <form class="main-filters" name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get">
    <div class="main-filters-inverse">
        <?
        foreach($arResult["HIDDEN"] as $arItem){
            ?><input type="hidden" name="<?echo $arItem["CONTROL_NAME"]?>" id="<?echo $arItem["CONTROL_ID"]?>" value="<?echo $arItem["HTML_VALUE"]?>" /><?
        }
        ?><div class="main-filters__title">
            Фильтры
        </div>
            ...
            <div class="main-filters-categories"><?
                ...
                foreach($arResult["ITEMS"] as $key=>$arItem)
                {
                    ...
                    if (
                        ...
                        continue;
                    ?><div class="main-filters-categories__title"><?=$arItem["NAME"]?></div>
                    <div class="main-filters-categories-items"><?
                        ...
                        default://CHECKBOXES
                            ...
                            ?><div class="main-filters-categories-items__link-wrap">
                                <input class="main-filters-categories-items__input" type="checkbox" value="<? echo $ar["HTML_VALUE"] ?>" name="<? echo $ar["CONTROL_NAME"] ?>" id="<? echo $ar["CONTROL_ID"] ?>"<?=$ar["CHECKED"]? 'checked="checked"': '' ?> onclick="smartFilter.click(this)"/>
                                <label class="main-filters-categories-items__link" data-role="label_<?=$ar["CONTROL_ID"]?>" for="<? echo $ar["CONTROL_ID"] ?>"><?=$ar["VALUE"];?></label>
                            </div><?
                            }
                        }
                    ?></div><?
        ...
        <div class="bx-filter-popup-result <?if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo $arParams["POPUP_POSITION"]?>" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?> style="display: none !important;">
