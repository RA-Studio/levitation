...
<div class="main-items-wrap">
    ...
    <div class="main-items" >
        ...
        foreach ($arResult['ITEM_ROWS'] as $rowData)
        {
            ...
            ?>
            <div class="main-items__item" data-entity="items-row">
                <?
    ...
    {?>
        ...
        if($USER->IsAdmin()){?>
            <div class="contacts" >
                <div class="contacts__title" style="margin: auto">В данном разделе пока нет товаров. Ждите новых поступлений!</div>
            </div>
        <?}else{?>
