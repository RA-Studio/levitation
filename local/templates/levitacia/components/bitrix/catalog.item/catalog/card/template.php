...
?><a class="main-items-card" href="<?=$item['DETAIL_PAGE_URL']?>">
        <?if($item['PROPERTIES']['UF_SALE_PERC']['VALUE']):?>
            <div class="sale-wrap">
				<span>-<?=$item['PROPERTIES']['UF_SALE_PERC']['VALUE']?>%</span>
			</div>
        <?endif;?>
        ...
        <div class="main-items-card-info">
            ...
            <div class="main-items-card-info__price" data-entity="price-block">
                    <?
                    ...
                    <span class="product-item-price-current" id="<?=$itemIds['PRICE']?>">
                            ...
                            if (!empty($price))
                            {
                                ...
                                else
                                {
                                    ...
                                    echo number_format($price['PRICE'], 0, '.', ' ' ) . ' <span>&#x20bd;</span>';
                                }
                            }
                            ?>
						</span>
