...
?><div id="<?=$itemIds['ID']?>">
<div class="good-gallery" id="<?=$itemIds['BIG_SLIDER_ID']?>">
...
{
    ?>
    <?//$sizeTable = getHLElement(5,['UF_TYPE' => $arResult['PROPERTIES']['TIP_TOVARA']['VALUE']])
    $sizeTable = [
        'UF_PREVIEW'=>$arResult['PROPERTIES']['UF_SIZE_TABLE_PREVIEW']['VALUE'],
        'UF_SIZES'=>$arResult['PROPERTIES']['UF_SIZE_TABLE_SIZES']['VALUE'],
    ];

    ?>
    <?if (!empty($sizeTable['UF_PREVIEW']) && !empty($sizeTable['UF_SIZES'])){?>
        <div class="good-content-params">
            <div class="product-item-detail-info-container">
                <a href="#" class="product-item-detail-sizeTable">Таблица размеров</a>
                <div id="sizeTable" style="display: none;">
                    <div class="sizeTable__title">Руководство по размерам</div>
                    <div class="sizeTable-content">
                        <img src="<?=CFile::GetPath($sizeTable['UF_PREVIEW'])?>" alt="<?=$sizeTable['UF_TYPE']?>">
                        <img src="<?=CFile::GetPath($sizeTable['UF_SIZES'])?>" alt="<?=$sizeTable['UF_TYPE']?> размеры">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="good-content-color product-item-scu-item-list"><?
                        foreach ($skuProperty['VALUES'] as $key=>&$value) {
                            ...
                            <li class="good-content-color__item"
                                ...
                                title="<?= $value['NAME'] ?>">
                                <span <?= $color['UF_HEX_COLOR'] ?'style="background:'.$color['UF_HEX_COLOR'].'"':''?>
                                   class="basket-item-scu-item-inner"></span>
                                <?= $value['NAME'] ?>
                            </li>
                        <? } ?>
                    </ul>
    ...
    ?></div>
    <?}?>
        <div class="good-content__add"
             id="<?= $itemIds['BASKET_ACTIONS_ID'] ?>" <?= ($actualItem['CAN_BUY'] ? '' : 'style="display: none"') ?>>
            <? if ($showAddBtn)
            {
