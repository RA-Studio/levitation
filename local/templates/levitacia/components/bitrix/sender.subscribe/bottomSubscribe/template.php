...
?>
<div class="new-subscribe"  id="sender-subscribe">
    <?
    ...
    <form id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
        ...
        <div class="new-subscribe__title">Узнайте о новых предложениях первыми</div>
        <input class="email-subs__email" pattern="([A-z0-9_.-]{1,})@([A-z0-9_.-]{1,}).([A-z]{2,8})" type="email" name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
        ...
        <?endif;?>
            <button class="email-subs__btn sender-btn" id="bx_subscribe_btn_<?=$buttonId?>"><span><?=GetMessage("subscr_form_button")?></span></button>
...
<?/*
    <div class="new-subscribe">
        <div class="new-subscribe__title">Узнайте о новых предложениях первыми</div>
        <input class="email-subs__email" pattern="([A-z0-9_.-]{1,})@([A-z0-9_.-]{1,}).([A-z]{2,8})" type="email" name="SENDER_SUBSCRIBE_EMAIL" value="" title="Введите ваш e-mail" required="" placeholder="Ваш E-Mail">
        <button class="email-subs__btn sender-btn " id="bx_subscribe_btn_sljzMT">Подписаться на рассылку</button>
    </div>
*/?>
