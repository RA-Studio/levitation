...
*/?>
		...
		<div class="basket-content-aside">
            <div class="basket-content-aside-box">
                ...
                <ul>
                    <li>Бесплатная доставка при первом заказе от 1500 рублей и 100% предоплате в городе Санкт-Петербург и Москва.</li>
					<li>Бесплатная доставка при повторном заказе от 5000 рублей и 100% предоплате в городе Санкт-Петербург и Москва.</li>
					<br>
                </ul>
                <span class="txt-uppercase">Бесплатная доставка в остальные города России (где присутствует СДЭК) при покупке от 5000 рублей, за исключением тех, которые перечислены ниже (СДЭК).<br><br></span>
