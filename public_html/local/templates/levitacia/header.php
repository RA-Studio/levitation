...
<div class="wrapper">
    ...
    <header class="header"><a class="header__logo" href="/"><img src="<?=SITE_TEMPLATE_PATH?>/assets/images/logo.png" alt=""></a><a class="header__cart" href="basket.html"><svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="header__burger"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="13" fill="none">
                <path d="M.5 11.933H18M.5.622H18M.5 6.277H18" stroke="#000"/>
            </svg>
        </div>
        <div class="header-menu">
            <div class="header-menu__close"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none">
                    <path d="M1 21L21 1m0 20L1 1" stroke="#000" stroke-width=".8"/>
                </svg>
            </div>
            <div class="header-menu-lang"><a class="header-menu-lang__item active" href="#">EN</a><a class="header-menu-lang__item" href="#">RU</a></div>
            <div class="header-menu__item"><a href="login.html">Login</a></div>
            <div class="header-menu__item" id="basket"><a href="basket-empty.html">Shopping bag<span> (0)</span></a></div>
            <div class="header-menu__item" id="basket"><a href="basket.html">Shopping bag<span> (2)</span></a></div>
            <div class="header-menu__item" id="search-btn"><a href="#">Search</a>
