...
<div id="<?=$itemIds['ID']?>">
            ...
            if ($showSliderControls)
            {
                if ($haveOffers)
                {
                    foreach ($arResult['OFFERS'] as $keyOffer => $offer)
                    {
                        ...
                        */?><!--
                        <div class="" id="<?/*=$itemIds['SLIDER_CONT_OF_ID'].$offer['ID']*/?>" style="display: <?/*=$strVisible*/?>;">
                            <?/*
                            foreach ($offer['MORE_PHOTO'] as $keyPhoto => $photo)
                            {
                                */?>
                                <div class="good-gallery-item"
    ...
    <div class="good-content"  itemscope itemtype="http://schema.org/Product">
        <?/*
                    <div class="product-item-detail-slider-container" style="display: none" id="<?=$itemIds['BIG_SLIDER_ID']?>">
                    ...
                    <ul class="good-content-color product-item-scu-item-list">
                        <?foreach ($skuProperty['VALUES'] as $key=>&$value)
                        {
                            ...
                            if ($skuProperty['CODE']==='TSVET')
                            {
                                switch ($value['NAME']){
                                    case 'чёрный':{
                                        $color = 'style="background: #1b1b1b"';
                                        break;
                                    }
                                    case 'серый меланж':{
                                        $color = 'style="background: #d6d6d6"';
                                        break;
                                    }
                                    case 'белый':{
                                        $color = 'style="background: #ececec"';
                                        break;
                                    }
                                    case 'красный':{
                                        $color = 'style="background: #ef002a"';
                                        break;
                                    }
                                    case 'жёлтый':{
                                        $color = 'style="background: #fdd541"';
                                        break;
                                    }
                                    case 'малиновый':{
                                        $color = 'style="background: #A71966"';
                                        break;
                                    }
                                    case  'тёмно-зелёный':{
                                        $color = 'style="background: #25423d"';
                                        break;
                                    }
                                    case 'тёмно-синий меланж':{
                                        $color = 'style="background: #3d3e52"';
                                        break;
                                    }
                                    case 'тёмно-синий':{
                                        $color = 'style="background: #23232f"';
                                        break;
                                    }
                                    case 'индиго':{
                                        $color = 'style="background: #3e5b7f"';
                                        break;
                                    }
                                    default:{
                                        $color = 'style="background: #5a008f"';
                                    }
                                }
                                ?>
                                ...
                                <li class="good-content-color__item"
                                    ...
                                    title="<?=$value['NAME']?>"
                                >
                                    <span <?=$color?> class="basket-item-scu-item-inner"></span>
                                    <?=$value['NAME']?>
                                </li>
                                <?
                            }
