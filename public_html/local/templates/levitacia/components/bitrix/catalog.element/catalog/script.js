		...
		basketResult: function(arResult)
		{
			...
			else
			{
				...
				if (arResult.STATUS === 'OK')
				{
					...
					popupContent = '<div class="product-wrapper" style="width: 100%; margin: 0; text-align: center;">'
						//+ '<img src="' + productPict + '" height="130" style="max-height:130px"><p>'
						+ '<p>' + this.product.name + '</p>' + '<h3 class="product-wrapper__price">' + numberWithSpaces(this.currentPrices[0].PRICE) + ' ₽' + '</h3>'+ '</div>';
