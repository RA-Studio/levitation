...
<form action="/" class="header-menu__item-search" method="get">
...
<?else:?>
    <input class="button" type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>"/>
    <!--<button type="submit">Ок</button>-->
<?endif;?>
    <label class="header-menu__item-search-label">
        <input type="submit" value="Ок" />
    </label>
    <?if (isset($_GET['q'])){?>
        <a class="button" type="text" href="/">/Reset</a>
    <?}?>
